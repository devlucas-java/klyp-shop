...
const dashboardDB = "dashboard_db.DashboardDB"
...
func (d *DashboardDB) CountOrdersByStatusForSeller(sellerID id.UUID) ([]repository.OrderStatusCount, error) {
	...
	if err != nil {
		return nil, apperrors.HandlePgError(dashboardDB+".count_orders_by_status_for_seller", err)
	}
	return rows, nil
}
...
func (d *DashboardDB) SumRevenueForSeller(sellerID id.UUID) (float64, error) {
	...
	if err != nil {
		return 0, apperrors.HandlePgError(dashboardDB+".sum_revenue_for_seller", err)
	}
	return revenue, nil
}
...
func (d *DashboardDB) CountProductsForSeller(sellerID id.UUID) (int64, error) {
	...
	if err != nil {
		return 0, apperrors.HandlePgError(dashboardDB+".count_products_for_seller", err)
	}
	return count, nil
}
...
func (d *DashboardDB) AvgRatingForSeller(sellerID id.UUID) (float64, int64, error) {
	...
	if err != nil {
		return 0, 0, apperrors.HandlePgError(dashboardDB+".avg_rating_for_seller", err)
	}
...
func (d *DashboardDB) TopProductsForSeller(sellerID id.UUID, limit int) ([]repository.ProductSalesRow, error) {
	...
	if err != nil {
		return nil, apperrors.HandlePgError(dashboardDB+".top_products_for_seller", err)
	}
	return rows, nil
}
...
func (d *DashboardDB) CountAllUsers() (int64, error) {
	...
	if err != nil {
		return 0, apperrors.HandlePgError(dashboardDB+".count_all_users", err)
	}
	return count, nil
}
...
func (d *DashboardDB) CountAllSellers() (int64, error) {
	...
	if err != nil {
		return 0, apperrors.HandlePgError(dashboardDB+".count_all_sellers", err)
	}
	return count, nil
}
...
func (d *DashboardDB) CountAllProducts() (int64, error) {
	...
	if err != nil {
		return 0, apperrors.HandlePgError(dashboardDB+".count_all_products", err)
	}
	return count, nil
}
...
func (d *DashboardDB) CountAllOrdersByStatus() ([]repository.OrderStatusCount, error) {
	...
	`).Scan(&rows).Error
	if err != nil {
		return nil, apperrors.HandlePgError(dashboardDB+".count_all_orders_by_status", err)
	}
	return rows, nil
}
...
func (d *DashboardDB) SumTotalRevenue() (float64, error) {
	...
	`).Scan(&revenue).Error
	if err != nil {
		return 0, apperrors.HandlePgError(dashboardDB+".sum_total_revenue", err)
	}
	return revenue, nil
}
...
func (d *DashboardDB) TopSellersByRevenue(limit int) ([]repository.SellerRevenueRow, error) {
	...
	if err != nil {
		return nil, apperrors.HandlePgError(dashboardDB+".top_sellers_by_revenue", err)
	}
	return rows, nil
}
